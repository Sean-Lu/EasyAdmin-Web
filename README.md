...
- 提供完整的 AI 助手页面，支持多轮对话、历史会话和回答来源查看
- 提供登录后的全局快捷入口，可在使用其他功能时快速发起轻量对话
- 支持查询当前用户有权访问的笔记、待办、日报、周报、月报、通知和菜单
- 支持生成笔记、待办、日报、周报和月报草稿，用户可检查内容并确认保存
- 超级管理员可配置 AI 模型服务和生成参数，并查看各租户的 AI 使用情况
- 租户管理支持独立启用 AI 功能并设置每日请求上限
