...
export const HYDRATE_LOCK = "HYDRATE_LOCK";
export const SYNCHRONIZE_LOCK_RUNTIME = "SYNCHRONIZE_LOCK_RUNTIME";
export const LOCK_SCREEN = "LOCK_SCREEN";
export const UNLOCK_SCREEN = "UNLOCK_SCREEN";
export const RECORD_LOCK_ACTIVITY = "RECORD_LOCK_ACTIVITY";
export const SET_LOCK_PREFERENCE = "SET_LOCK_PREFERENCE";
export const RESET_LOCK_RUNTIME = "RESET_LOCK_RUNTIME";
