...
import { FileBizType, FileStoreType, uploadFile } from "../../../services/system/fileService";
...
const FileUpload: React.FC<FileUploadProps> = ({ onSuccess }) => {
	...
	const handleSubmit = async () => {
		try {
			...
			const result = await uploadFile(file, FileStoreType.LocalFile, values.description, FileBizType.Normal);
