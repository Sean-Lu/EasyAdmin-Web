...
import { ParamValueType, serializeParamValue } from "./paramValueUtils";
...
// 参数新增弹窗
export default class ParamAdd extends React.Component {
	render() {
		const { modalVisible, onCancel, onSubmit } = this.props;
		return (
			<Modal open={modalVisible} title="新增参数信息" footer={null} destroyOnHidden onCancel={onCancel}>
				<Form
					labelCol={{ span: 6 }}
					wrapperCol={{ span: 17 }}
					layout="horizontal"
